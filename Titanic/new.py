...
train = pd.read_csv("~/Documents/data/train.csv", dtype={"Age": np.float64}, )
test = pd.read_csv("~/Documents/data/test.csv", dtype={"Age": np.float64}, )
...
full = pd.concat([full,pd.get_dummies(full['Sx'])],axis=1)
